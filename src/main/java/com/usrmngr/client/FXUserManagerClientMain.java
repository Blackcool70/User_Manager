...
public class FXUserManagerClientMain extends Application {
    ...
    private void loadConfigView() {
        String configViewFXML = "/fxml/client/ConfigWindow/ConfigMainView.fxml";
        loadAsChildWindow(configViewFXML, "Configurations");
    }

    private void loadMainView() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/client/ClientMainView.fxml"));
    ...
    public static void loadAsChildWindow(String fxmlPath, String title) {
        try {
            ...
            configWindow.setScene( new Scene(FXMLLoader.load(FXUserManagerClientMain.class.getResource(fxmlPath))));
