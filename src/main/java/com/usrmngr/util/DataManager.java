...
import com.usrmngr.client.core.model.FXDialogs.ExceptionDialog;
...
import static com.usrmngr.server.core.model.Constants.DEFAULT_CONFIG_FILE_NAME;
...
public class DataManager {
    ...
    public static  Properties getProperties(){
        return getProperties(getUserDataDirectory().concat(DEFAULT_CONFIG_FILE_NAME));
    }
    ...
    public static void saveConfigFile(Properties properties) {
        String dataPath = getUserDataDirectory().concat(DEFAULT_CONFIG_FILE_NAME);
